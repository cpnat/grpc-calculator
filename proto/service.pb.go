...
type Request struct {
	...
	A int64 `protobuf:"varint,1,opt,name=a,proto3" json:"a,omitempty"` // numbers denote the size of the serialised data type
	B int64 `protobuf:"varint,2,opt,name=b,proto3" json:"b,omitempty"` // each needs a unique number (1-15 reserved for 1 byte)
}
